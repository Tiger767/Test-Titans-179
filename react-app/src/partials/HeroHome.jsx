...
import HeroImage from '../images/vendia.png';
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">
              Test Titans: CSC 179 PharmaStudy
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              This project uses Vendia to conduct a pharma study between Jane Hopkins, Bavaria, and the FDA.
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://share.vendia.net/" target="_blank" rel="noreferrer">
                  Start Now
                </a>
              </div>
              <div data-aos="fade-up" data-aos-delay="600">
                <a className="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="https://www.vendia.com/docs/share/vendia-client-sdk" target="_blank" rel="noreferrer">
                  Learn more
                </a>
              </div>
            </div>
