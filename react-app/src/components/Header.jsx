        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link to="/" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">About Us</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/signin" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">Sign in</Link>
              </li>
            </ul>
